...
var Button = function Button(_ref) {
  var text = _ref.text,
    dark = _ref.dark;
  var buttonClass = dark ? styles.darkButton : styles.lightButton;
...
function useFetchState(url) {
  var _useState = reactExports.useState([]),
    ...
    getter = _useState2[0],
    setGetter = _useState2[1];
  function getYourData() {
    return _getYourData.apply(this, arguments);
  }
  function _getYourData() {
    _getYourData = _asyncToGenerator(/*#__PURE__*/_regeneratorRuntime().mark(function _callee() {
      var response, yourData;
